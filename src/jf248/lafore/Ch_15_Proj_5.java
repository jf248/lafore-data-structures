...
public class Ch_15_Proj_5 {
  ...
  class Graph {
    ...
    public void doHamiltonian(int homeVertex) {
    ...
    private void checkPath(int[] path) {
      ...
      if (d < INFINITY) {
        char[] labels = new char[path.length];
        for (int i = 0; i < labels.length; i++) {
          labels[i] = vertexList[path[i]].label;
        }
        System.out.println(String.valueOf(labels));
      }
    }
  ...
  public static void main(String[] args) {
    Ch_15_Proj_5 app = new Ch_15_Proj_5();
