...
public class Ch_12_Proj_1_2 {
  ...
  public static void main(String[] args) throws IOException {
    int value, value2;
    Ch_12_Proj_1_2 app = new Ch_12_Proj_1_2();
    Heap theHeap = app.new Heap(31);
    boolean success;
    ...
    while (true) {
      ...
      System.out.print("show, insert, remove, change, toss, heap-restore : ");
      int choice = getChar();
      switch (choice) {
        case 's':
          theHeap.displayHeap();
